...
- (void)viewDidLoad
{
    ...
    self.OptionViewTable.layer.cornerRadius = 30;
    self.OptionViewTable.scrollEnabled = NO;
    ...
    self.OptionImageView.image = image1;
    self.navigationItem.hidesBackButton = YES;
...
- (void)viewDidUnload
{
    ...
    [self setOptionViewTable:nil];
    [self setOptionImageView:nil];
    [self setOptionViewTable:nil];
...
{
   OptionListCell * cell = (OptionListCell *)[tableView dequeueReusableCellWithIdentifier:@"OLCell"];
    
    if(cell == nil ) // !cell means that if cell is nil
    {
        cell = [[OptionListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"OLCell"];
    }
    ...
    if (row == 0)
    {
        cell.optionListLabel.text = @"Your Hubs";
    ...
    {
        cell.optionListLabel.text = @"Your Profile";
    ...
    {
        cell.optionListLabel.text = @"Directory";
